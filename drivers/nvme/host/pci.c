...
static blk_status_t nvme_map_data(struct request *req)
{
	...
	if (nvme_rq_is_dmabuf_attached(req)) {
		if (use_sgl == SGL_FORCED) {
			...
			/* Regular path doesn't fall back if SGLs are forced. */
